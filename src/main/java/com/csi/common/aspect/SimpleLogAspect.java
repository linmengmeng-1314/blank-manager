...
import com.csi.common.annotation.SimpleLog;
...
public class SimpleLogAspect{
	...
	@Pointcut("@annotation(com.csi.common.annotation.SimpleLog)")
	...
	public Object around(ProceedingJoinPoint point) throws Throwable {
		...
		//记录执行后返回日志
		resultSimpleLog(point, result.toString(),System.currentTimeMillis()-beginTime,number);
