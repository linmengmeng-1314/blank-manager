...
import com.csi.modules.sys.service.SysRoleService;
...
public class SysRoleController extends AbstractController {
	 ...
	 * 根据用户id获取用户角色名称列表
	 */
	@RequestMapping("/nameList/{userId}")
	@RequiresPermissions("sys:role:info")
	public R nameList(@PathVariable("userId")Integer userId){
		List<String> roleNameList = sysUserRoleService.queryRoleNameList(userId);
		return R.ok().put("roleNameList", roleNameList);
	}
