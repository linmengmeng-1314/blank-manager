 ...
 */
@RestController
@Api(value="后台登录操作",tags={"13、后台登录操作"})
public class SysLoginController {
	...
	@ApiOperation(value="1.用户登陆",produces="application/json",httpMethod="POST",tags="用户登陆")
	public Map<String, Object> login(String username, String password, String captcha)throws IOException {
		...
		r.put("customPassword", user.getCustomPassword());
		return r;
	}
