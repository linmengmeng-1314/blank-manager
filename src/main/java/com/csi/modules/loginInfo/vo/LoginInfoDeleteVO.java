 ...
 */
@ApiModel("删除参数")
public class LoginInfoDeleteVO {
	...
	public String toString(){
		...
		builder.append("com.csi.modules.loginInfo.vo.LoginInfoDeleteVO ={")
	...
	public static class LoginInfoDResultVO {

		private static LoginInfoDResultVO success = new LoginInfoDResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static LoginInfoDResultVO fail = new LoginInfoDResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public LoginInfoDResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("com.csi.modules.loginInfo.vo.LoginInfoDResultVO =")
		...
		public static LoginInfoDResultVO ok() {
			return success;
		}
	
		public static LoginInfoDResultVO  fail() {
			return fail;
		}
