...
public class LoginInfoSaveVO {
	...
	public String toString(){
		...
		builder.append("com.csi.modules.loginInfo.vo.LoginInfoSaveVO ={")
	...
	public static class LoginInfoSResultVO {
		private static LoginInfoSResultVO fail = new LoginInfoSResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());

		private static LoginInfoSResultVO success= new LoginInfoSResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		...
		public LoginInfoSResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("com.csi.modules.loginInfo.vo.LoginInfoSResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public LoginInfoSResultVO(){
		}
		...
		public static LoginInfoSResultVO ok() {
			return success;
		}
	
		public static LoginInfoSResultVO  fail() {
			return fail;
		}
