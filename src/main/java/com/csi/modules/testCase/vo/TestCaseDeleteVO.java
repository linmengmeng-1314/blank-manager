...
public class TestCaseDeleteVO {
	...
	public String toString(){
		...
		builder.append("com.csi.modules.testCase.vo.TestCaseDeleteVO ={")
		.append("id=").append(id)
	...
	public static class TestCaseDResultVO {

		private static TestCaseDResultVO success = new TestCaseDResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static TestCaseDResultVO fail = new TestCaseDResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public TestCaseDResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("com.csi.modules.testCase.vo.TestCaseDResultVO =")
		...
		public static TestCaseDResultVO ok() {
			return success;
		}
	
		public static TestCaseDResultVO  fail() {
			return fail;
		}
