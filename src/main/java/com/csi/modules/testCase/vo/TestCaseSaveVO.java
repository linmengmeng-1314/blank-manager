...
public class TestCaseSaveVO {
	...
	public String toString(){
		...
		builder.append("com.csi.modules.testCase.vo.TestCaseSaveVO ={")
		.append("id=").append(id)
	...
	public static class TestCaseSResultVO {
		private static TestCaseSResultVO fail = new TestCaseSResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());

		private static TestCaseSResultVO success= new TestCaseSResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		...
		public TestCaseSResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("com.csi.modules.testCase.vo.TestCaseSResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public TestCaseSResultVO(){
		}
		...
		public static TestCaseSResultVO ok() {
			return success;
		}
	
		public static TestCaseSResultVO  fail() {
			return fail;
		}
