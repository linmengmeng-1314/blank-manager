...
public class QZDYDeleteVO {
	...
	public String toString(){
		...
		builder.append("com.csi.modules.qzdy.vo.QZDYDeleteVO ={")
	...
	public static class QZDYDResultVO {

		private static QZDYDResultVO success = new QZDYDResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static QZDYDResultVO fail = new QZDYDResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public QZDYDResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("com.csi.modules.qzdy.vo.QZDYDResultVO =")
		...
		public static QZDYDResultVO ok() {
			return success;
		}
	
		public static QZDYDResultVO  fail() {
			return fail;
		}
