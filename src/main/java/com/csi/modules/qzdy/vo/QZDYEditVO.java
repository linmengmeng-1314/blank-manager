...
public class QZDYEditVO {
	...
	public String toString(){
		...
		builder.append("com.csi.modules.qzdy.vo.QZDYEditVO ={")
	...
	public static class QZDYEResultVO {

		private static QZDYEResultVO success = new QZDYEResultVO(ReturnMsgEnum.SUCCESS.getCode(),ReturnMsgEnum.SUCCESS.getMsg());
		private static QZDYEResultVO fail = new QZDYEResultVO(ReturnMsgEnum.FAIL.getCode(),ReturnMsgEnum.FAIL.getMsg());
		@ApiModelProperty(value="状态码",allowableValues="200:成功,其他表示失败")
		private String code;
		@ApiModelProperty(value="返回修改结果信息")
		private String msg;
		
		public QZDYEResultVO(String code,String msg){
			this.code = code;
			this.msg = msg;
		}
		...
		public String toString(){
			StringBuilder builder = new StringBuilder();
			builder.append("com.csi.modules.qzdy.vo.QZDYEResultVO ={")
			.append("code=").append(code)
			.append(",msg=").append(msg)
			.append("}");
			return builder.toString();
		}
		public QZDYEResultVO(){
		}
		...
		public static QZDYEResultVO ok() {
			return success;
		}
	
		public static QZDYEResultVO fail() {
			return fail;
		}
